                        ...
                        <div className="col">
                            <Paper className='row-md-6' elevation={12} sx={{ p: 2, }}>
                                ...
                                <div className="row g-2 p-2">
                                    ...
                                    <div className="col-md-12 d-flex justify-content-between">
                                        <TextField  size='small' fullWidth variant='outlined' onChange={handleItemAddChange} value={itemAddData.itemCertificateNo} label="Certificate No" name='itemCertificateNo'></TextField>

                                        <Button component="label"  className='ms-2' value={itemAddData.itemCertificateName} variant="contained" fullWidth >
                        ...
                        >
                            ...
                            <DialogContent>
                                <DialogContentText id="alert-dialog-description">
                                    Are you sure to Make copy of this Item
                                </DialogContentText>
                            </DialogContent>
                            <DialogActions>
                                <Button onClick={() => setOpen(false)}>Cancel</Button>
                                <Button type="button" onClick={(e) => { makeItemCopy(e); setOpen(false); }} autoFocus>
                                    Create Copy
                                </Button>
                            </DialogActions>
                        </Dialog>
