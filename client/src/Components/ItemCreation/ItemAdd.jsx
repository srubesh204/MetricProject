...
const ItemAdd = () => {
    ...
    const [itemAddData, setItemAddData] = useState({
        itemPlant: employeeRole.loggedEmp[0].plant.length !== 0 && employeeRole.loggedEmp[0].plant.length === 1 ? employeeRole.loggedEmp[0].plant[0] : "",
        itemMasterRef: "",
        selectedItemMaster: [],
        isItemMaster: "0",
        itemAddMasterName: "",
    ...
    const validateFunction = () => {
        ...
        tempErrors.itemPlant = itemAddData.itemPlant ? "" : "Plant is Required"
                                ...
                                <Paper elevation={12} sx={{ p: 2 }} className='row-md-6'>
                                    ...
                                    <div className="row g-2 mt-0 mb-2">
                                        <div className='col-md-6'>
                                            <TextField
                                                {...(errors.itemPlant !== "" && { helperText: errors.itemPlant, error: true })}
                                                size='small' select variant='outlined' label="Select Plant" id='itemPlantId' name='itemPlant' value={itemAddData.itemPlant} fullWidth onChange={handleItemAddChange}>
