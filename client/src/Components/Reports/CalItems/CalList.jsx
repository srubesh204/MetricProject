...
const CalList = () => {
    ...
    const calListColumns = [
        ...
        { field: 'printButton', headerName: 'Print', headerAlign: "center", align: "center", width: 60, renderCell: (params) => <Button component={Link} to={`${process.env.REACT_APP_PORT}/certificates/${params.row.calCertificateNo}.pdf`} target='_blank'><PrintRounded color='success' /></Button> }
    ]
