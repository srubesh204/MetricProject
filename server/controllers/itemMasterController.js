...
const itemMasterController = {
    getAllItemMasters: async (req, res) => {
      ...
      createItemMaster: async (req, res) => {
        ...
        try {
          const { itemType, itemDescription, itemPrefix, itemFqInMonths, calAlertInDay, wiNo, uncertainty, uncertaintyUnit, standardRef, itemImageName, workInsName, status,calibrationPoints} = req.body;
          const itemMasterResult = new itemMasterModel({ itemType, itemDescription, itemPrefix, itemFqInMonths, calAlertInDay, wiNo, uncertainty, uncertaintyUnit, standardRef, itemImageName, workInsName, status,calibrationPoints});
