...
const formatNoController = {
    getAllFormatNo: async (req, res) => {
      ...
      createFormatNo: async (req, res) => {
        ...
        try {
          const { formatId, fDc, fGrn, fCertificate, fHistoryCard, fTotalList, fCalDueDate, fCertificatePrefix,  fDeTemperature, fDeHumidity} = req.body;
          const formatNoResult = new formatNoModel({formatId,fDc, fGrn, fCertificate, fHistoryCard, fTotalList, fCalDueDate, fCertificatePrefix,  fDeTemperature, fDeHumidity});
        ...
        updateFormatNo: async (req, res) => {
          try {
            ...
            const updateFormatNoFields = {
              ...
              formatId: req.body.formatId, fDc: req.body.fDc, fGrn: req.body.fGrn, fCertificate: req.body.fCertificate, fHistoryCard: req.body.fHistoryCard, fTotalList: req.body.fTotalList, fCalDueDate: req.body.fCalDueDate, fCertificatePrefix: req.body.fCertificatePrefix,  fDeTemperature: req.body. fDeTemperature, fDeHumidity: req.body.fDeHumidity,// Example: updating the 'name' field
